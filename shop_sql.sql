...
CREATE TABLE BOOK_IMG(
  ...
  , BOOK_NUM INT NOT NULL REFERENCES SHOP_BOOK (BOOK_NUM) ON DELETE CASCADE #부모키 삭제 시 자식키도 삭제.
);
...
INSERT INTO SHOP_BUY VALUES(1,50000,'123',SYSDATE());
INSERT INTO BUY_DETAIL VALUES(1,1,1,1);
INSERT INTO BUY_DETAIL VALUES(2,2,2,1);

INSERT INTO SHOP_BUY VALUES(2,100000,'123',SYSDATE());
