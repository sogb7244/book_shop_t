      ...
      <div className={styles.address}>
        ...
        <div>
          <Input
            ...
            onChange={e =>handleJoinData(e)} />
          <Button 
            title='검색' variant='gray'
            onClick={
              e => open({ onComplete: handleComplete })
            }/>
        </div>
          <Input 
            name='addrDetail'
